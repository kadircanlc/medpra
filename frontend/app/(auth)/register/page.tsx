...
import { Stethoscope, Brain, Heart, Zap, Mail, Lock, ArrowRight, User } from "lucide-react";
    ...
    >
      ...
      <div className="relative z-10 bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl shadow-purple-100 p-10 w-full max-w-md mx-4">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-400 text-sm">Hesap Oluştur</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-sm font-semibold text-gray-600 mb-2">Ad Soyad</label>
